...
public:
  Visualization() : Node("visualization") {
    ...
    this->vehicle_attitude_topic =
      this->declare_parameter("vehicle_attitude", "/fmu/out/vehicle_attitude");
    this->vehicle_local_position_topic =
      this->declare_parameter("vehicle_local_position", "/fmu/out/vehicle_local_position");
    this->path_topic =
      this->declare_parameter("path_topic", "visualization/path");
    ...
    this->counter = 0;
    this->path_timer = this->create_wall_timer(50ms, [this]() {
