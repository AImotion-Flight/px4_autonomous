...
#ifndef GAZEBO_PLUGINS__OCCUPANCY_GRID_PLUGIN_HPP_
#define GAZEBO_PLUGINS__OCCUPANCY_GRID_PLUGIN_HPP_
...
class OccupancyGridPlugin : public gazebo::WorldPlugin
{
public:
  /// Constructor
  OccupancyGridPlugin();
...
private:
  ...
  /// data members.
  std::unique_ptr<OccupancyGridPluginPrivate> impl_;
};
}  // namespace gazebo

#endif  // GAZEBO_PLUGINS__OCCUPANCY_GRID_PLUGIN_HPP_